...
- [Student Outcome ABET–EAC – Student Outcome 5](#student-outcome-abeteac--student-outcome-5)
    - [**F1nTrack – KapakID**](#f1ntrack--kapakid)
...
- [Capítulo V: Product Implementation, Validation \& Deployment](#capítulo-v-product-implementation-validation--deployment)
  ...
  - [Sprint Backlog 1 – Proyecto KapakID](#sprint-backlog-1--proyecto-kapakid)
    - [Sprint Goal](#sprint-goal)
    - [Control de Estado del Sprint 1](#control-de-estado-del-sprint-1)
    ...
    - [5.2.1.5. Execution Evidence for Sprint Review](#5215-execution-evidence-for-sprint-review)
      ...
      - [Home de la Landing Page](#home-de-la-landing-page)
      - [Apartado de Beneficios](#apartado-de-beneficios)
      - [Casos de Éxito](#casos-de-éxito)
      - [Contacto](#contacto)
      - [Observaciones Finales del Sprint Review](#observaciones-finales-del-sprint-review)
  ...
  - [5.2.3. Sprint 2](#523-sprint-2)
    ...
    - [Control de Estado del Sprint 2](#control-de-estado-del-sprint-2)
    - [Resumen de Estimaciones](#resumen-de-estimaciones-1)
    - [Observaciones](#observaciones-3)
    - [5.2.2.4. Development Evidence for Sprint Review](#5224-development-evidence-for-sprint-review)
    - [5.2.2.5. Execution Evidence for Sprint Review](#5225-execution-evidence-for-sprint-review)
      - [Login de Usuario](#login-de-usuario)
      - [Register de Usuario](#register-de-usuario)
      - [Dashboard Principal](#dashboard-principal)
      - [Gestión de Documentos](#gestión-de-documentos)
      - [Módulo de Recargas y Pagos](#módulo-de-recargas-y-pagos)
      - [Notificaciones y Alertas](#notificaciones-y-alertas)
      - [Transport](#transport)
      - [History](#history)
      - [Technical Support](#technical-support)
      - [Observaciones Finales del Sprint Review](#observaciones-finales-del-sprint-review-1)
    ...
    - [5.2.2.8. Team Collaboration Insights during Sprint](#5228-team-collaboration-insights-during-sprint-1)
      - [**Evidencia colaborativa**](#evidencia-colaborativa)
    - [**Observaciones del trabajo colaborativo**](#observaciones-del-trabajo-colaborativo)
      - [5.2.3.1. Sprint Planning 3](#5231-sprint-planning-3)
      - [5.2.3.2. Aspect Leaders and Collaborators.](#5232-aspect-leaders-and-collaborators-1)
      - [5.2.3.3. Sprint Backlog 3.](#5233-sprint-backlog-3)
      - [5.2.3.4. Development Evidence for Sprint Review.](#5234-development-evidence-for-sprint-review)
      - [5.2.3.5. Execution Evidence for Sprint Review.](#5235-execution-evidence-for-sprint-review)
    - [🟦 Frontend – Evidencia por Módulo](#-frontend--evidencia-por-módulo)
      - [Login](#login)
      - [Register](#register)
      - [Gestión de Documentos](#gestión-de-documentos-1)
      - [Dashboard Principal](#dashboard-principal-1)
      - [Notificaciones](#notificaciones)
      - [Recargas y Pagos](#recargas-y-pagos)
      - [Transport](#transport-1)
      - [History](#history-1)
      - [Technical Support](#technical-support-1)
    - [Backend – Evidencia de Servicios (KapakID API)](#backend--evidencia-de-servicios-kapakid-api)
      - [Auth (Login / Register)](#auth-login--register)
      - [Documentos (POST / PATCH / GET)](#documentos-post--patch--get)
      - [Alertas y Notificaciones (GET / POST /alerts /notifications)](#alertas-y-notificaciones-get--post-alerts-notifications)
      - [Transport / Movimientos (GET /transport/movements)](#transport--movimientos-get-transportmovements)
    - [🟩 Resumen del Sprint 3](#-resumen-del-sprint-3)
- [5.2.4. Sprint 4 – Proyecto KapakID](#524-sprint-4--proyecto-kapakid)
  - [5.2.4.1. Planificación del Sprint 4](#5241-planificación-del-sprint-4)
  - [5.2.4.2. Líderes de Aspecto y Colaboradores](#5242-líderes-de-aspecto-y-colaboradores)
  - [5.2.4.3. Sprint Backlog 4 – Proyecto KapakID](#5243-sprint-backlog-4--proyecto-kapakid)
  - [5.2.4.4. Evidencia de Desarrollo](#5244-evidencia-de-desarrollo)
  - [5.2.4.5. Evidencia de Ejecución](#5245-evidencia-de-ejecución)
  - [Evidencias del Front-End (Vercel)](#evidencias-del-front-end-vercel)
    - [Evidencia 1 – Login funcionando en producción](#evidencia-1--login-funcionando-en-producción)
    - [Evidencia 2 – Register funcionando en producción](#evidencia-2--register-funcionando-en-producción)
    - [Evidencia 3 – Dashboard Integrado](#evidencia-3--dashboard-integrado)
    - [Evidencia 4 – Gestión de Documentos desde el Front-End](#evidencia-4--gestión-de-documentos-desde-el-front-end)
    - [Evidencia 5 – Notificaciones en producción](#evidencia-5--notificaciones-en-producción)
    - [Evidencia – Módulo Pagos en producción](#evidencia--módulo-pagos-en-producción)
    - [Evidencia – Módulo Transporte en producción](#evidencia--módulo-transporte-en-producción)
    - [Evidencia – Módulo Histórico en producción](#evidencia--módulo-histórico-en-producción)
    - [Evidencia – Módulo Soporte en producción](#evidencia--módulo-soporte-en-producción)
- [Evidencias del Back-End (RailWay)](#evidencias-del-back-end-railway)
    - [Evidencia  – API REST desplegada en Railway](#evidencia---api-rest-desplegada-en-railway)
    - [Evidencia  – Swagger Documentation](#evidencia---swagger-documentation)
    - [Evidencia  – Endpoints funcionando (GET / POST / PATCH)](#evidencia---endpoints-funcionando-get--post--patch)
    - [Evidencia  – Logs y disponibilidad del servicio](#evidencia---logs-y-disponibilidad-del-servicio)
    - [Evidencia  – Integración Back-End con Front-End](#evidencia---integración-back-end-con-front-end)
- [5.3. Validation Interviews (KapakID)](#53-validation-interviews-kapakid)
  - [5.3.1. Diseño de entrevistas](#531-diseño-de-entrevistas)
    - [User goals (tareas críticas por rol)](#user-goals-tareas-críticas-por-rol)
      - [User Goal: Registrarse y elegir suscripción/plan (S1, S2)](#user-goal-registrarse-y-elegir-suscripciónplan-s1-s2)
      - [User Goal: Iniciar sesión (S1, S2)](#user-goal-iniciar-sesión-s1-s2)
      - [User Goal: Editar su perfil (S1, S2)](#user-goal-editar-su-perfil-s1-s2)
      - [User Goal: Gestionar documentos (registrar, editar, visualizar) (S1, S2)](#user-goal-gestionar-documentos-registrar-editar-visualizar-s1-s2)
      - [User Goal: Pagos y recargas (S1, S2)](#user-goal-pagos-y-recargas-s1-s2)
      - [User Goal: Transporte y tarjetas (S1)](#user-goal-transporte-y-tarjetas-s1)
      - [User Goal: Notificaciones y alertas (S1, S2)](#user-goal-notificaciones-y-alertas-s1-s2)
  - [5.3.2. Registro de entrevistas](#532-registro-de-entrevistas)
    - [Entrevistas a estudiantes universitarios (S1)](#entrevistas-a-estudiantes-universitarios-s1)
  - [5.3.3. Evaluaciones según heurísticas](#533-evaluaciones-según-heurísticas)
    ...
    - [Problemas Identificados – Web Application](#problemas-identificados--web-application)
  - [5.4. Video About-the-Product (KapakID)](#54-video-about-the-product-kapakid)
...
- [Anexos](#anexos)
  ...
  - [Evaluación del SO5 – Trabajo en Equipo, Liderazgo y Colaboración](#evaluación-del-so5--trabajo-en-equipo-liderazgo-y-colaboración)
    - [✔️ Resultado General del SO5](#️-resultado-general-del-so5)
  - [Anexo B: Indicaciones y Enlaces de Videos](#anexo-b-indicaciones-y-enlaces-de-videos)
  - [Anexo C: Formato para Evaluación de User Experience según Heurísticas](#anexo-c-formato-para-evaluación-de-user-experience-según-heurísticas)
- [Anexo D. Formato para Evaluación de User Experience según Heurísticas](#anexo-d-formato-para-evaluación-de-user-experience-según-heurísticas)
  ...
  - [TAREAS EVALUADAS](#tareas-evaluadas)
    - [TAREAS NO INCLUIDAS EN ESTA VERSIÓN:](#tareas-no-incluidas-en-esta-versión)
  - [ESCALA DE SEVERIDAD](#escala-de-severidad-1)
  - [TABLA RESUMEN DE PROBLEMAS DETECTADOS](#tabla-resumen-de-problemas-detectados)
- [DESCRIPCIÓN DE PROBLEMAS (CON RECOMENDACIONES)](#descripción-de-problemas-con-recomendaciones)
  - [**PROBLEMA #1 – No existe confirmación clara al subir un documento**](#problema-1--no-existe-confirmación-clara-al-subir-un-documento)
    - [**Problema**](#problema)
    - [**Recomendación**](#recomendación)
  - [**PROBLEMA #2 – El botón para volver al Dashboard no es visible**](#problema-2--el-botón-para-volver-al-dashboard-no-es-visible)
    - [**Problema**](#problema-1)
    - [**Recomendación**](#recomendación-1)
  - [**PROBLEMA #3 – Iconos sin etiquetas accesibles**](#problema-3--iconos-sin-etiquetas-accesibles)
    - [**Problema**](#problema-2)
    - [**Recomendación**](#recomendación-2)
  - [PROBLEMA #4 – Mensajes de error poco descriptivos en recargas](#problema-4--mensajes-de-error-poco-descriptivos-en-recargas)
    - [Problema](#problema-3)
    - [Recomendación](#recomendación-3)
  - [PROBLEMA #5 – Información de Transporte dispersa](#problema-5--información-de-transporte-dispersa)
    - [Problema](#problema-4)
    - [Recomendación](#recomendación-4)
  - [PROBLEMA #6 – Alertas sin fecha exacta](#problema-6--alertas-sin-fecha-exacta)
    - [Problema](#problema-5)
...
| Edad          | 25            |
| Distrito      | Surco         |
| Foto          | ![Foto entrevistado 4](<resources/Cap-2/registro de entrevistas/imagen-freddy.png>) |
...
#  Evidencias del Back-End (RailWay)

###  Evidencia  – API REST desplegada en Railway
**Descripción:** Despliegue exitoso del Back-End con funciones operativas.  
**Captura:**  
![Backend en Railway](resources/Cap-5/sprint4/sprint4-backend-netlify.png)
...
**Descripción:** Confirmación de logs operativos y disponibilidad continua en el hosting de Railway.  
**Captura:**  
![Logs Railway](resources/Cap-5/sprint4/sprint4-logs.png)
